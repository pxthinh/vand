...
<form style="margin:30px;" method="POST" action="{{route('store-product-admin')}}" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <textarea class="ckeditor form-control" name="description" id="product_description" placeholder="Mô tả sản phẩm" rows="7"></textarea>
                    @error('description')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
